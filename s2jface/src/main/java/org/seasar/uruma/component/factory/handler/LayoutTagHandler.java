...
/**
 * <code>fillLayout</code>、<code>rowLayout</code>、<code>gridLayout</code>
 * 要素に対するタグハンドラです。<br />
 * 
 * @author y-komori
 */
public class LayoutTagHandler extends GenericTagHandler {
    ...
    protected void setParent(final UIElement uiElement,
        ...
        parent.setLayoutInfo((LayoutInfo<?>) uiElement);
    }
}
