...
public class ActionDescImplTest extends TestCase {
    public void testTarget01() throws Exception {
        ...
        assertEquals(Target01.class.getMethod("initialize", (Class[]) null),
                target01.getInitializeMethod());
    }

    public void testTarget02() throws Exception {
        try {
    ...
    public void testTarget03() throws Exception {
        try {
